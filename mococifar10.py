...
Original file is located at
    https://colab.research.google.com/github/KevinMusgrave/pytorch-metric-learning/blob/master/examples/notebooks/MoCoCIFAR10.ipynb
...
def create_dataset(batch_size):
    ...
    train_dataset = datasets.CIFAR10("dataset", train=True, download=True, transform=train_transform)
    train_dataset_for_eval = datasets.CIFAR10("dataset", train=True, download=True, transform=val_transform)
    val_dataset = datasets.CIFAR10("dataset", train=False, download=True, transform=val_transform)
